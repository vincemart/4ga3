...
```
We can see that the p value is now a relatively large number, which means that this remedial action has worked and Reg1_SEM will be our model. (I dont know what to do with it tho, do we just say it worked)
